...
def measure_distances():
    # Replace 'nuclease' with the name of the nuclease object in PyMOL
    nuclease_object = 'chain A'
    
    # Replace 'dna' with the name of the DNA object in PyMOL
    dna_object = 'chain C'
    
    # Replace 'protein' with the name of the protein object in PyMOL
